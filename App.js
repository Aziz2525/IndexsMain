...
export default function App({ navigation }) {
    ...
    const bootstrapAsync = async () => {
      ...
      try {
        ...
        if(userToken)
        {
          ...
          socket.on('get client id', async (id)=>{
            await SecureStore.setItemAsync("myID",id);
          })
        }
      } catch (e) {
        console.log(e);
  ...
  function Tabs() {
    return (
      <>
      <Tab.Navigator initialRouteName="Messagess" screenOptions={{
        ...
        <Tab.Screen name="Messages" component={Messages} options={{
          ...
          tabBarIcon:({ color, size })=>{
            return(
              ...
              <Feather name="bar-chart" size={26} color={color}/>
        ...
        <Tab.Screen name="Search" component={Search} options={{
         ...
         <Tab.Screen name="Messagess" component={Messages} options={{
          title:'Mesajlar',
          headerRight: () => {
            return (
              <Ionicons
            ...
            <>
              ...
              <Stack.Screen
                ...
                options={({ route, navigation }) => ({
                  ...
                  headerLeft: () => {
                    return (
                      <TouchableOpacity style={styles.messageBack} onPress={() => navigation.goBack()}>
                        <Feather
                          name="chevron-left"
                          size={30}
                          color="black"
